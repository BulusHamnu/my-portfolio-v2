...
function ServicesSection() {
  return (
    <section id="services" className="p-3">
      ...
      <div id="services-cont" className="flex flex-row flex-wrap gap-7 mt-6 justify-center md:justify-start">
        {Services.map((service) => (
          <div className="flex-1 p-2 min-w-75 max-w-125 ">
